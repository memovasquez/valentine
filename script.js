...
function showYippeeCat() {
    ...
    var noButton = document.getElementById("toggleButton");
    var againButton = document.getElementById("againButton");
    yesButton.classList.add('hide-buttons');
    noButton.classList.add('hide-buttons');
    // againButton.classList.remove('hide-buttons');
    // againButton.classList.remove('answer--yes');

    happyHappyHappy.play();
}

function startOver() {
    var valentineContainer = document.getElementById("valentineContainer");
    var buttons = document.querySelectorAll('.custom-btn');
    valentineContainer.classList.remove("answer--yes");
    buttons.forEach(button => button.classList.remove('hide-buttons'));
    happyHappyHappy.pause();
}
